...
def inference_callback(completion_info, bindings_list, input_batch):
    """
    Process inference results and return them.
    ...
    Returns:
        list of (frame, result)
    """

    if completion_info.exception:
        raise RuntimeError(f"Inference error: {completion_info.exception}")
    ...
    for i, bindings in enumerate(bindings_list):
        ...
        outputs.append((input_batch[i], result))
